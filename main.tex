...
\chapter{Related work}
    \input{Content/2_related_work} \label{related_work}
\chapter{Theory}
    \input{Content/3_theory}
\chapter{Method \& Materials}
    \input{Content/4_method_materials}
\chapter{Analysis}
    \input{Content/5_analysis}
\chapter{Implementation}
    \input{Content/6_implementation}
    \chapter{Evaluation} \label{evaluation}
    \input{Content/7_evaluation}
\chapter{Results}
    \input{Content/8_results}
\chapter{Discussion}
    \input{Content/9_discussion}
\chapter{Conclusions}
    \input{Content/10_conclusions}
