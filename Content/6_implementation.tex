The implementation of the parallel program is outlined in this chapter, including indentification of sources of overhead encountered while writing the code.
