This chapter describes initial program analysis, including profiling for program bottlenecks, as well as code and filter inspection
conducted in order to indentify parallelization opportunities and obstacles.
