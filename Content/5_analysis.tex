...
\end{itemize}
The time spent in the function above is 87.7\% of the toal time, and the rest of the code in \code{process} is contained in the body of the loop that iterates
over and performs actions on every row.\\
