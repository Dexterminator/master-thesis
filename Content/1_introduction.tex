...
Consequently, it is interesting to find the combinations of dataset sizes, as well as their filters, that result in beneficial parallelization,
and which do not.
...
and uses only the Python \code{multiprocessing} module (chosen with support of related work in the field).
