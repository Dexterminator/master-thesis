...
for parallelization analysis.  Looking through the filters, we can see that Dataset translation, NullTranslationFilter, Relation currency,
...
Additionally, Dataset information, Tradefile information, Logger, and Skip row perform operations that either pull information from resources that
are available to all rows, or produce an effect that does not affect any other rows.
