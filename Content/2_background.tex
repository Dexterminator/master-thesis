...
enables the processes to utilize true parallelism. The processes are represented by the \code{multiprocessing.Process} class.

The \code{multiprocessing} module provides two main mechanisms for performing IPC, listed below \cite{palach_2014_parallel_ppwp}.
...
In addition to the above parallel programming utilities, the \code{multiprocessing} module provides the \code{Pool} abstraction
