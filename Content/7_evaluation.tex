This chapter describes the different ways the parallel program was evaluated. This includes profiling the implemented program, performing calculations
using different performance models, and outlining experiments conducted to benchmark the parallel performance.
