...
\begin{itemize}
  ...
  \item Actual testing will be done in TriOptima’s acceptance test environment, with hardware similar to what is used in production. This is a stationary computer running Linux CentOS, with a dual processor
